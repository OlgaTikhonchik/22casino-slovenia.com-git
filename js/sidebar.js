  ...
  if (button2 && list2) {
    ...
    button2.addEventListener("click", function () {
      ...
      if (isActive) {
        ...
        // Сброс на auto, чтобы получить точную scrollHeight
        list2.style.maxHeight = "none";
        const scrollHeight = list2.scrollHeight;
        list2.style.maxHeight = "0"; // принудительный сброс
        // Маленькая задержка для перехода
...
//       } else {
//         list2.style.maxHeight = "none";
//         const height = list2.scrollHeight;
//         list2.style.maxHeight = height + "px";
//       }
